            ...
            <div class="ec-bottom-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">
                            <a href="#" class="ec-footer-logo"><img width="30%"  src="webs/images/<?php echo String_Get_Valores('favicon');?>" alt=""></a>
                            <div class="ec-copyright">
                                <p>©<?php echo String_Get_Valores('año');?> <?php echo String_Get_Valores('copyright');?></p>
                            </div>
                        </div>
                        <div class="col-md-7">
