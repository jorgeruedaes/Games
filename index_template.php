...
<body>
    ...
    <div class="ec-main-wrapper">
        ...
        <a href="https://themeforest.net/item/eye-sports-fixtures-and-sports-wordpresss-theme/19002764?ref=eyecix" class="ec-get-wordpress">Get WordPress Version</a>
        <!--// Main Header \\-->
        <header id="ec-header">
            <!--// TopSection \\-->
                            ...
                            <ul>
                                ...
                                <li><a href="#">Shop</a>
                                    <ul class="as-dropdown">
                                        ...
                                        <li><a href="shop-list.html">List Wout/sidebar</a></li>
                                        <li><a href="shop-list-wsidebar.html">List W/sidebar</a></li>
                                        <li><a href="shop-list-w-b-sidebar.html">List Wboth/sidebar</a></li>
                                ...
                                <li><a href="#">Pages</a>
                                    <ul class="as-dropdown">
                                        <li><a href="#">Players</a>
                                            <ul class="as-dropdown">
                                                <li><a href="plyer-list.html">plyer list right/sidebar</a></li>
                                                <li><a href="plyer-list-left-sbar.html">plyer list Wleft/sidebar</a></li>
                                                <li><a href="plyer-list-nosidebar.html">plyer list Wout/sidebar</a></li>
                                                <li><a href="plyer-detail.html">plyer detail</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">shortcode</a>
                                            <ul class="as-dropdown">
                                                ...
                                                <li><a href="promobox.html">PromoBox</a></li>
                                                <li><a href="testimonial.html">Testimonial</a></li>
                                                <li><a href="alert-mesage.html">Alert MESSAGEs</a></li>
                                                <li><a href="heading-type.html">Heading Style</a></li>
                            ...
                            <ul class="as-menu">
                                ...
                                <li><a href="#">Shop</a>
                                    <ul class="as-submenu">
                                        ...
                                        <li><a href="shop-list-w-b-sidebar-2.html">Shop List W/both/sidebar</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="ec-sponsored">
                                <div class="item">
                                    <a href="#"><img src="extra-images/partner-logo-1.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img src="extra-images/partner-logo-2.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img src="extra-images/partner-logo-3.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img src="extra-images/partner-logo-4.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img src="extra-images/partner-logo-5.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img src="extra-images/partner-logo-6.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <!--// Partner \\-->
                                ...
                                <ul class="row">
                                    <li class="col-md-12">
                                        <div class="ec-blog-wrap">
                                            <figure>
                                                <a href="#"><img src="extra-images/blog-medium-1.jpg" alt=""></a>
                                                <figcaption>
                                    ...
                                    <li class="col-md-12">
                                        <div class="ec-blog-wrap">
                                            <figure>
                                                <a href="#"><img src="extra-images/blog-medium-2.jpg" alt=""></a>
                                                <figcaption>
                                    ...
                                    <li class="col-md-12">
                                        <div class="ec-blog-wrap">
                                            <figure>
                                                <a href="#"><img src="extra-images/blog-medium-3.jpg" alt=""></a>
                                                <figcaption>
                        ...
                        <div class="col-md-12">
                            <div class="ec-shop ec-shop-list">
                                <ul class="row">
                                    <li class="col-md-3">
                                        <figure>
                                            <a href="#" class="ec-shop-thumb"><img src="extra-images/shop-list-1.jpg" alt=""></a>
                                    ...
                                    <li class="col-md-3">
                                        <figure>
                                            <a href="#" class="ec-shop-thumb"><img src="extra-images/shop-list-2.jpg" alt=""></a>
                                            <figcaption>
                                                <ul>
                                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                                    <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                    ...
                                    <li class="col-md-3">
                                        <figure>
                                            <a href="#" class="ec-shop-thumb"><img src="extra-images/shop-list-3.jpg" alt=""></a>
                                            <span class="ec-festured">Sale</span>
                                            <figcaption>
                                                <ul>
                                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    ...
                                    <li class="col-md-3">
                                        <figure>
                                            <a href="#" class="ec-shop-thumb"><img src="extra-images/shop-list-4.jpg" alt=""></a>
                                            <figcaption>
                                                <ul>
                                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                                    <li><a href="#"><i class="fa fa-heart"></i></a></li>
...
<!-- Mirrored from eyecix.com/html/eyesports/index.html by HTTrack Website Copier/3.x [XR&CO'2010], Fri, 07 Apr 2017 20:20:18 GMT -->
</html>
