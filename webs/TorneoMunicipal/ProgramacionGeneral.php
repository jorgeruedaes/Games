						...
						<ul>
							...
							foreach ($vectores as $values)
							{
								...
								<li class="calendar-detail add-pointer" id="<?php echo $values['id_partido']?>">
									...
									<div class="ec-cell">
									<img class="width-15" src="<?php echo LogoClub(ClubEquipo($values['equipo1']))?>" />
									<span>
									<?php echo NombreEquipo($values['equipo1'])?></span>
									</div>
									...
									<div class="ec-cell">
									<img class="width-15" src="<?php echo LogoClub(ClubEquipo($values['equipo2']))?>" />
									<span><?php echo NombreEquipo($values['equipo2'])?></span>
									</div>
